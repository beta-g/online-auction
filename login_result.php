...
{ 
    ...
    echo"<script>alert('Login Failed. Email does not exist or Password Incorrect')</script>";
...
{  
    ...
    echo '<script>alert("You are now logged in as: '. $_SESSION['account_type'] . 'You will be redirected shortly");</script>';
    mysqli_close($connection);
