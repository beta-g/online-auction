...
<?php
  ...
  $listing_query = "SELECT  user_id, endtime, itemdescription, item_title, listing_id, startprice, image FROM listings WHERE listing_id = '$item_id'";
...
$customer_phone = $row_customer['Phone_Num'];
$customer_add = $row_customer['Address'];
...
<div class="row"> <!-- Row #2 with auction description + bidding info -->
  <div class="col-sm-8"> <!-- Left col with item info -->
    ...
    <div class="">
    <?php echo '
                  <img src="uploads/'.$row['image'].'" height="400" width"400"></td> 
                  ';?>
    </div>
...
<?php else: ?>
    ...
    <p class="lead">Current bid: Br<?php echo(number_format($current_price, 2)) ?></p>
...
<br>
<div class="contact">
<h5>Contact <?php echo $customer_phone; ?></h5>
</div>  
<div class="contact">
<h5>Address <?php echo $customer_add; ?></h5>
</div> 
<div class="contact">
<h5>Email <?php echo $customer_email; ?></h5>
</div> 
</div>
